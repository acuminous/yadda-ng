...
module.exports = class Specification {
  ...
  createBackground({ annotations, title }) {
    this._feature.background = { annotations, title, description: [], steps: [] };
    this._stepTarget = this._feature.background;
    return this;
  }

  describeBackground({ text }) {
    this._feature.background.description.push(text);
    return this;
  }

  createScenario({ annotations, title }) {
    this._scenario = { annotations, title, description: [], steps: [] };
  ...
  describeScenario({ text }) {
    this._stepTarget.description.push(text);
    return this;
  }
