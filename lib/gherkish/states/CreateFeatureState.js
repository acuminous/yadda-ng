...
const { AnnotationEvent, BackgroundEvent, BlankLineEvent, DocStringStartEvent, EndEvent, FeatureEvent, LanguageEvent, MultiLineCommentEvent, ScenarioEvent, SingleLineCommentEvent, TextEvent } = require('../events');
const events = [ EndEvent, DocStringStartEvent, LanguageEvent, MultiLineCommentEvent, SingleLineCommentEvent, AnnotationEvent, FeatureEvent, BackgroundEvent, ScenarioEvent, BlankLineEvent, TextEvent ];
