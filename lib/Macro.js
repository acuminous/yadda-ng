...
// TODO Work out what to return in Step Outcome. Probably needs to be an object, with property for returned value
// TODO rename fn to callback
...
module.exports = class Macro {
  ...
  reportDuplicate(other) {
    this._signature.reportDuplicate(other);
  }
