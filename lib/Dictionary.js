...
module.exports = class Dictionary {
  ...
  define(...args) {
    if (args.length === 1) return this._define(args[0]);
    if (args.length === 2) return this._define(args[0], args[1]);
    if (args.length === 3) return this._define(args[0], args[1], [].concat(args[2]));
  }
