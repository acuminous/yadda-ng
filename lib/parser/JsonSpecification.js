...
module.exports = class JsonSpecification {
  ...
  createBackgroundStep({ annotations, statement, generalised }) {
    this._feature.background.steps.push({ annotations, statement, generalised });
    return this;
  }
  ...
  createScenarioStep({ annotations, statement, generalised }) {
    const scenario = this._currentScenario();
    scenario.steps.push({ annotations, statement, generalised });
    return this;
  }
