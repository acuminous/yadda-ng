const debug = require('debug')('yadda-ng:arities:FixedArity');
...
module.exports = class FixedArity {
  ...
  validate(step, supply, demand) {
    ...
    throw new Error(`Step [${step.statement}] yielded ${this._formatSupply(supply, demand)} using ${this._signature}, but ${this._formatDemand(supply, demand)} specified`);
  }
