...
module.exports = class MochaPlaybook extends FeaturePlaybook {
        ...
        feature.forEach((scenario) => {
          ...
          self._describe(scenario)(scenario.title, function() {
            ...
            scenario.forEach((step) => {
              ...
              self._it(step)(step.text, async function() {
                self._applyAnnotations(this, step);
                return step.run(scenario._state);
              });
            });
          });
        });
  ...
  _describe(subject) {
    return subject.isSkipped() ? global.xdescribe : global.describe;
  }

  _it(subject) {
    return subject.isSkipped() ? global.xit : global.it;
  }
