...
module.exports = class EnglishLibrary extends Library {
  ...
  __define(type, ...args) {
    return args.length === 1 && args[0].signatures
      ? this._define({ ...args[0], signatures: args[0].signatures, type })
      : this._define({ type, signatures: args[0], fn: args[1], converters: args[2] });
  }
};
